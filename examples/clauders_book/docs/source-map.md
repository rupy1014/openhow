...
### 02장 자동화 감 잡기
- `examples/clauders.ai/docs/자동화/00-4가지기능.md` — 자동화 큰 그림
- `examples/clauders.ai/docs/자동화/01-작업맡기기.md` — 한 단계씩 맡기는 감각
- `examples/clauders.ai/docs/자동화/02-멀티에이전트.md` — 워크플로우/서브에이전트 설명용
- `examples/clauders.ai/docs/자동화/05-브라우저자동화.md` — 블로그 발행 자동화 참고
- `examples/clauders.ai/docs/AI로일하기/00-AI로일하기.md` — 실무 자동화 감각

### 03장 완전 초보자를 위한 설명
- `examples/clauders.ai/docs/완전초보/01-AI기초.md` — AI/모델/회사 구분
- `examples/clauders.ai/docs/완전초보/03-개발환경.md` — GUI/CLI/환경 개념
- `examples/clauders.ai/docs/완전초보/04-컨텍스트.md` — 컨텍스트와 메모리
- `examples/clauders.ai/docs/완전초보/05-계획모드.md` — 계획 모드 감각
- `examples/clauders.ai/docs/레시피/03-codex-orchestration.md` — 오케스트레이션/설정 예시

### 04장 웹소설 자동화
- `/Users/taesupyoon/sideProjects/web-novel/docs/웹소설_작가되기_웹소설_장르.md` — 연재 생태계와 독자 기대치
- `/Users/taesupyoon/sideProjects/web-novel/docs/웹소설_PD가_알려주는_플랫폼별_특징.md` — 플랫폼/연재 맥락
- `/Users/taesupyoon/sideProjects/web-novel/docs/웹소설_1화_작성하는_방법_독자를_사로잡는_5가지_공식_1.md` — 초반 회차 설계
- `/Users/taesupyoon/sideProjects/web-novel/docs/술술_읽히는_문장_실전_웹소설_퇴고하는_법.md` — 퇴고와 품질 개선
- `examples/clauders.ai/docs/부록/03-1-write-scene.md` — 장면 단위 작성 파이프라인

## Part 2. 기초 다지기 — 바이브코딩 입문

### 05장 AI 캐릭터 채팅 서비스 빠르게 만들어보기
- `examples/clauders.ai/docs/바이브코딩/02-바이브기획.md` — 기획 흐름
- `examples/clauders.ai/docs/바이브코딩/02-1-PRD작성법.md` — plan 모드/요구사항 정리
...
### 07장 PG 붙이기
- `examples/clauders.ai/docs/바이브코딩연재/08-API와-데이터-흐름.md` — 외부 결제 API를 붙이는 기본 감각
- `examples/clauders.ai/docs/바이브코딩연재/22-외부-API-연결하기.md` — 외부 서비스 연동 관점
- `examples/clauders.ai/docs/입문/05-비용관리.md` — 결제/운영 비용 감각
- `examples/clauders.ai/docs/바이브코딩연재/13-배포하기.md` — 테스트 후 실제 환경에 연결하는 흐름

### 08장 나도 한번 만들어볼까
- `examples/clauders.ai/docs/바이브코딩/02-2-안만들것.md` — MVP 범위 자르기
- `examples/clauders.ai/docs/바이브코딩/08-피드백.md` — 빠른 피드백 루프 + 흔한 함정 정리
- `examples/clauders.ai/docs/바이브코딩연재/10-기획-뭘-만들지-정하기.md` — 스코프/기획 언어 보강

## Part 3. 자동화의 뼈대 — OpenClaw와 구조 읽기

### 09장 OpenClaw 설치하고 첫 대화 나누기
- OpenClaw 가이드 PDF (chapters 6-10: 설치, 14: 첫 성공 경험)
- `backlog/자동화/29-맥미니-세팅.md` — Mac Mini 세팅 맥락
- `backlog/자동화/28-AI-비서는-어떻게-만들어졌을까.md` — AI 비서 프레이밍
...
- `examples/clauders.ai/docs/AI회사/05-승인과-비용은-어떻게-봐.md` — 승인/비용/기록
- OpenClaw 가이드 PDF (chapter 23: 스킬, cron, 하트비트, 플러그인)

## Part 4. 실전 자동화 유즈케이스 — OpenClaw와 함께

### 13장 뉴스봇 자동화 — OpenClaw가 매일 아침 보고합니다
- `backlog/자동화/27-뉴스-요약-봇-만들기.md` — 뉴스봇 초안 (핵심 베이스)
...
- `examples/clauders.ai/docs/자동화/03-사례모음.md` — 자동화 아이디어 발상
...
- `backlog/자동화/28-AI-비서는-어떻게-만들어졌을까.md` — 비서 프레이밍
